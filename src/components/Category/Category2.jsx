...
const Category2 = () => {
  ...
  <div className="container">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* third col */}
        <div data-aos="zoom-in"  className="col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-600/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end">
        <div>
          <div className="mb-4">
      ...
      {/* first col */}
    <div data-aos="zoom-out" className="py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/70 text-white rounded-3xl relative h-[320px] flex items-start">
        <div>
          <div data-aos="zoom-in" className="mb-4">
            <p data-aos="zoom-in" className="md-[2px] text-white">Enjoy</p>
            <p data-aos="zoom-in" className="text-2xl font-semibold">With</p>
            <p data-aos="zoom-in" className="text-4xl xl:text-5xl font-bold opacity-20 md-2">Earphone</p>
