...
<div className='container'>
  <div className='overflow-hidden rounded-3xl min-h-[550px] sm:min-h-[660px] flex justify-center items-center'>
<div className='container pd-8 sm:pd-0 hero-bg-color'>
        {/* Hero Section */}
        <Slider {...settings}>
          {
            HeroData.map((data) => (
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2'>
          ...
          sm:text-left order-2 sm:order-1 relative z-10'>
                ...
                <div data-aos="zoom-out" data-aos-duration="500" data-aos-offset="300">
               ...
               <div className='order-1 sm:order-2'>
                  ...
                  <img src={data.img} alt="" className='w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] sm:scale-105 lg:scale-110 opject-contain mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] relative z-40'  />
                    </div>
                   </div>
            </div>
